...
Alignment app for any two people who share responsibilities and need to stay in sync. Live at **https://do-do.app**
...
| `invite-email.js` | Partner invite email via Resend |
...
| `stripe-expense-payment.js` | Stripe PaymentIntent for shared expense reimbursement |
...
| `/#calendar` | Shared calendar with Google Calendar and Apple CalDAV |
...
| Partner invite flow | Live |
| Web push notifications + quiet hours | Live |
| Email reminders (cron, 15 min - needs Vercel Pro) | Live |
| App subscription (Stripe, 14-day trial, localized pricing - PLN/EUR/CHF) | Live |
...
- Supabase RLS enforces pair-level data isolation
