...
(function () {
  ...
  const GUIDES = {
    ...
    welcome: [
      { target: null,                                     titleKey: "guide.welcome.1.title",  bodyKey: "guide.welcome.1.body",  position: "center" },
      { target: ".module-link[data-module='board']",      titleKey: "guide.welcome.2.title",  bodyKey: "guide.welcome.2.body",  position: "bottom" },
      { target: ".module-link[data-module='calendar']",   titleKey: "guide.welcome.3.title",  bodyKey: "guide.welcome.3.body",  position: "bottom" },
      { target: ".module-link[data-module='shopping']",   titleKey: "guide.welcome.4.title",  bodyKey: "guide.welcome.4.body",  position: "bottom" },
    ],

    "setup-parents": [
      { target: null,                                     titleKey: "guide.parents.1.title",  bodyKey: "guide.parents.1.body",  position: "center" },
      { target: "#caregiversPanel",                       titleKey: "guide.parents.2.title",  bodyKey: "guide.parents.2.body",  position: "top" },
      { target: "#invitePanelContent",                    titleKey: "guide.parents.3.title",  bodyKey: "guide.parents.3.body",  position: "top" },
    ],

    "setup-children": [
      { target: null,                                     titleKey: "guide.children.1.title", bodyKey: "guide.children.1.body", position: "center" },
      { target: "#addChildBtn",                           titleKey: "guide.children.2.title", bodyKey: "guide.children.2.body", position: "bottom" },
      { target: null,                                     titleKey: "guide.children.3.title", bodyKey: "guide.children.3.body", position: "center" },
    ],

    "setup-schedule": [
      { target: ".module-link[data-module='calendar']",   titleKey: "guide.schedule.1.title", bodyKey: "guide.schedule.1.body", position: "bottom" },
      { target: "#calPageBcalSection",                    titleKey: "guide.schedule.2.title", bodyKey: "guide.schedule.2.body", position: "top" },
      { target: ".module-link[data-module='przekazanie']",titleKey: "guide.schedule.3.title", bodyKey: "guide.schedule.3.body", position: "bottom" },
      { target: null,                                     titleKey: "guide.schedule.4.title", bodyKey: "guide.schedule.4.body", position: "center" },
    ],

    "setup-vacation": [
      { target: null,                                     titleKey: "guide.vacation.1.title", bodyKey: "guide.vacation.1.body", position: "center" },
      { target: ".mini-cal-picker",                        titleKey: "guide.vacation.2.title", bodyKey: "guide.vacation.2.body", position: "top" },
      { target: null,                                     titleKey: "guide.vacation.3.title", bodyKey: "guide.vacation.3.body", position: "center" },
    ],

    "calendar-connect": [
      { target: null,                                     titleKey: "guide.calcon.1.title",   bodyKey: "guide.calcon.1.body",   position: "center" },
      { target: "#calendarSettingsPanel",                 titleKey: "guide.calcon.2.title",   bodyKey: "guide.calcon.2.body",   position: "top" },
      { target: null,                                     titleKey: "guide.calcon.3.title",   bodyKey: "guide.calcon.3.body",   position: "center" },
    ],

    shopping: [
      { target: ".module-link[data-module='shopping']",   titleKey: "guide.shopping.1.title", bodyKey: "guide.shopping.1.body", position: "bottom" },
      { target: ".shopping-add",                           titleKey: "guide.shopping.2.title", bodyKey: "guide.shopping.2.body", position: "top" },
      { target: null,                                     titleKey: "guide.shopping.3.title", bodyKey: "guide.shopping.3.body", position: "center" },
    ],
  };
