...
// Temporal Dead Zone crash. render() is called synchronously during init.
// DE tip content pending Bart review - EN used as fallback for now.
const DAILY_TIPS = [
  // Praise
  ...
  { en: "Read one page together tonight - it doesn't matter what, it matters that you're side by side.", pl: "Przeczytajcie razem jedna strone wieczorem - co czytacie nie wazne, wazne ze jestescie obok siebie.", de: "Read one page together tonight - it doesn't matter what, it matters that you're side by side." },
