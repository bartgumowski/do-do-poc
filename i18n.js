...
(function () {
  ...
  const DICT = {
    ...
    en: {
      ...
      "board.new_do":         "New Do",
      "board.welcome":        "WELCOME",
      "board.empty_subtitle": "Your board is ready. Add your first Do to get started.",
      ...
      "expense.tab.monthly":                 "Monthly",
      "expense.tab.recurring":               "Recurring",
      "expense.monthly_commitment":          "Est. monthly commitment",
      ...
      "cal.mine":             "Mine",
      "cal.split":            "Split",
      "cal.split_day":        "Split day",
      "cal.tab.agenda":       "Agenda",
      "cal.tab.schedule":     "Schedule",
      "cal.tab.changes":      "Changes",
      "cal.tab.vacations":    "Vacations",
      "cal.reset":            "Reset",
      "cal.change":           "Change",
      "cal.item":             "item",
      "cal.item_s":           "s",
    ...
    de: {
      ...
      "board.welcome":        "WILLKOMMEN",
      "board.empty_subtitle": "Das Board ist bereit. Füge dein erstes Do hinzu, um zu starten.",
      ...
      "expense.tab.monthly":                 "Monatlich",
      "expense.tab.recurring":               "Wiederkehrend",
      "expense.monthly_commitment":          "Gesch. monatliche Ausgaben",
      ...
      "cal.mine":             "Meine",
      "cal.split":            "Übergabe",
      "cal.split_day":        "Übergabe",
      "cal.tab.agenda":       "Agenda",
      "cal.tab.schedule":     "Zeitplan",
      "cal.tab.changes":      "Änderungen",
      "cal.tab.vacations":    "Urlaub",
    ...
    pl: {
      ...
      "board.welcome":        "WITAJ",
      "board.empty_subtitle": "Tablica jest gotowa. Dodaj swoje pierwsze Do.",
      ...
      "expense.tab.monthly":                 "Miesięczne",
      "expense.tab.recurring":               "Powtarzalne",
      "expense.monthly_commitment":          "Szac. miesięczne zobowiązania",
      ...
      "cal.mine":             "Moje",
      "cal.split":            "Przekazane",
      "cal.split_day":        "Przekazanie",
      "cal.tab.agenda":       "Agenda",
      "cal.tab.schedule":     "Plan",
      "cal.tab.changes":      "Zamiany",
      "cal.tab.vacations":    "Wakacje",
      "cal.reset":            "Wyczyść",
      "cal.change":           "Zmiana",
      "cal.item":             "pozycja",
      "cal.item_s":           "",
      ...
      "sched.this_week_all":      "Zastosuj zmianę planu dla wszystkich tygodni",
